...
def PWPAE(X_train, y_train, X_test, y_test):
    ...
    t1 = multiprocessing.Process(target=train_model, args=(hat1, X_train, y_train))
    t2 = multiprocessing.Process(target=train_model, args=(hat2, X_train, y_train))
    t3 = multiprocessing.Process(target=train_model, args=(hat3, X_train, y_train))
    t4 = multiprocessing.Process(target=train_model, args=(hat4, X_train, y_train))
